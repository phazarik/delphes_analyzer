...
void overlay()
{
  ...
  TString filename1 = "../outputs/hst_ppToZToLL.root";
  TString filename2 = "../outputs/hst_ppToZToLL.root";
  ...
  TString plotname1 = "m_ee";
  TString plotname2 = "m_ll"; //(here we are picking the same plot from other file)


  //Also give fancy name for the axis titles
  TString xtitle = "M_{ll} [GeV]"; // Can use latex-type commands
  ...
  */
  ...
  lg1->AddEntry(h1,"ee","lf"); // Added the two entries for the two histograms
  lg1->AddEntry(h2,"#mu#mu","lp");           // we shall be drawing.
